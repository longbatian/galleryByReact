...
// import icons from '../styles/iconfont.css';
...
class ControllerUnits extends React.Component {
  ...
  render () {
    ...
    let controllerUnitsClassName2="",
      controllerUnitsClassName3="";
    controllerUnitsClassName2 = (this.props.arrange.isCenter) ? 'is-center' : '';
    controllerUnitsClassName3 = (this.props.arrange.isInverse) ? 'is-inverse' : '';

    return (
      <span className={styles[controllerUnitsClassName]
        +" "+styles[controllerUnitsClassName2]
    +" "+styles[controllerUnitsClassName3]} onClick={this.handleClick.bind(this)}></span>
    )
  }
}
// ----------添加图片组件，搭建图片结构
class ImgFigure extends React.Component{
  ...
  render(){
    ...
    let ImgFigureClassName2="";
    ImgFigureClassName2 = this.props.arrange.isInverse ? 'is-inverse' : 'nulls';  // 两个类名之间要有空格分隔，is-inverse前面注意有个空格
    // console.log(ImgFigureClassName2)
    return(
      <figure className={styles[ImgFigureClassName]+" "+styles[ImgFigureClassName2]} style={styleObj} onClick={this.figureClick.bind(this)}>
          <div>
        ...
        <figcaption>
          <h2 className={styles["img-title"]}>{this.props.data.title}</h2>
          <div className={styles["img-back"]} onClick={this.figureClick.bind(this)}>
            <p>
...
//获取图片相关数据
let imageDatas = require('../imgjson/imageDatas.json');
  ...
  render() {
    ...
    return (
      <section className={styles["stage"]} ref="stage">
        <section className={styles["img-sec"]}>
          {imgFigures}
        </section>
        <nav className={styles["controller-nav"]}>
          {controllerUnits}
        </nav>
      </section>
    );
